...
export function AiScan({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[#0b0e17] px-6">
      <div className="w-full max-w-sm text-center">
        <p className="inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.24em] text-cyan-300">
